...
func TestLegacyReceiptDecoding(t *testing.T) {
	...
	tx := NewTransaction(1, common.HexToAddress("0x1"), big.NewInt(1), 1, big.NewInt(1), nil, nil, nil, QueueOriginSequencer, SighashEIP155)
	receipt := &Receipt{
...
func TestDeriveFields(t *testing.T) {
	...
	txs := Transactions{
		NewContractCreation(1, big.NewInt(1), 1, big.NewInt(1), nil, nil, nil, QueueOriginSequencer),
		NewTransaction(2, common.HexToAddress("0x2"), big.NewInt(2), 2, big.NewInt(2), nil, nil, nil, QueueOriginSequencer, SighashEIP155),
	}
